...
//     getItem('Xác thực người dùng', '7', <FaEye />),
//     getItem('Vị trí', '8', <FaMapLocationDot />),
//     getItem('Cài đặt', '9', <IoSettings />),
// ];
...
//     const handleClick = (e) => {
//         const routes = ["/", "/analytics", "/users", "/report", "/advice", "/package", "/verification", "/location", "/settings"];
