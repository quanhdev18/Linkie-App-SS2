...
//         >
//           <img
//             src={m.avatar ? getAvatarImage(m.avatar.id || m.avatar) : defaultAvatar}
//             alt={m.username || "User"}
//             className="w-12 h-12 rounded-full object-cover border-[2px] border-yellow-400"
//           />
//         </div>
...
//   //   const avatarUrl = avatarObj
//   //     ? getAvatarImage(
//   //         typeof avatarObj === "object" ? avatarObj.id || avatarObj.title : avatarObj
//   //       )
//   //     : null;
...
//     if (avatarObj) {
//       if (typeof avatarObj === "object") {
//         avatarUrl = getAvatarImage(avatarObj.id || avatarObj.title);
//       } else if (typeof avatarObj === "number") {
//         avatarUrl = getAvatarImage(avatarObj);
...
//           //     ? getAvatarImage(
//           //         typeof m.avatar === "object" ? m.avatar.id || m.avatar.title : m.avatar
//           //       )
//           //     : defaultAvatar;
...
//             if (m.avatar) {
//               if (typeof m.avatar === "object") {
//                 // Nếu object có id thì lấy id, nếu không thì lấy title
//                 avatarUrl = getAvatarImage(m.avatar.id || m.avatar.title);
//               } else if (typeof m.avatar === "number") {
//                 avatarUrl = getAvatarImage(m.avatar);
