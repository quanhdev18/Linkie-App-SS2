...
export default function ProfileDetail() {
  const { profileId, name, age, location } = useLocalSearchParams();
  ...
  //       const data = await getProfileById(numericProfileId, token);
  //       setProfile(data);
  ...
  // }
  if (!profile) {
  return <AppLoading text="Người ấy sẽ xuất hiện ngay bây giờ" />;
}
