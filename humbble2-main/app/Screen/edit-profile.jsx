...
const EditProfile = () => {
  ...
  try {
    ...
    if (status !== "granted") {
      Toast.show({
        type: "error",
        text1: "Cần quyền truy cập vị trí",
        text2: "Vui lòng bật quyền vị trí để tiếp tục",
      });
      return;
    }
    ...
    // 4️⃣ Update location lên BE
    await updateLocation(accountId, latitude, longitude);

    // 5️⃣ Reverse geocode → tên địa điểm
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View
        style={{
          minHeight: SCREEN_HEIGHT * 0.65, // 🔥 căn giữa theo máy
