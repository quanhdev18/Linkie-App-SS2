...
export default function Discover() {
  ...
  const DiscoverLoading = ({ themeColors }) => {
    return (
      <View
        style={{
          flex: 1,
      ...
      >
        ...
        <Text style={{ marginTop: 12, color: themeColors.text }}>
          Đang tìm người phù hợp cho bạn...
        </Text>
      </View>
    );
  };
  ...
  const DiscoverSectionsLoading = () => (
    <View style={{ marginTop: 20 }}>
      <AppLoading text="Bình tĩnh, tình yêu đang tới…" />
    </View>
  );
  ...
  return (
    <>
      ...
      >
        ...
        <View
          style={{
            minHeight: SCREEN_HEIGHT * 0.65, // 🔥 chiếm phần còn lại màn hình
            justifyContent: "center",
          }}
        >
          {loading ? (
            <AppLoading text="Đang tìm người phù hợp cho bạn..." />
          ) : (
            <>
              <Recommendataions />
              <GoalSection />
