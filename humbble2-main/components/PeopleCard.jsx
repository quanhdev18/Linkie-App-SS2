...
//     // 1️⃣ Lấy data gốc (recommendations)
...
//     // 2️⃣ FILTER FRONTEND (GIỐNG LOGIC CŨ)
//     if (filterData) {
...
//         const ageMatch =
//           (!filterData.minAge || age >= filterData.minAge) &&
//           (!filterData.maxAge || age <= filterData.maxAge);
...
const fetchAllData = useCallback(async () => {
  ...
  try {
    ...
    // 3️⃣ LOAD AVATAR + PROFILE IMAGES
      ...
      filtered.map(async (user) => {
        ...
        try {
          ...
          if (imageData.profile_images?.length) {
            imageData.profile_images.forEach((img) => {
              images.push({
        ...
        return {
          ...user,
          account_id: user.id, // 🔥 RẤT QUAN TRỌNG
          images,
          hobbies: user.hobby || [],
              ...
              return (
                ...
                >
                  <View style={styles.card}>
                    ...
                    <ImageBackground
  source={{
    uri: card.images?.[0]?.url || undefined,
  }}
  style={styles.image}
  imageStyle={styles.imageInner}
>
                      ...
                      <View style={styles.infoSection}>
                        ...
                        <Text style={styles.locationText}>
                          {card.location_name || "Không rõ vị trí"}
                        </Text>
                      </View>
                    </ImageBackground>
                  </View>
